...
import com.ssd.blog.payload.CommentDto;
import com.ssd.blog.payload.PostDto;
import com.ssd.blog.serviceimpl.CommentServiceImpl;
...
public class CommentController {
    ...
    public ResponseEntity<CommentDto> getCommentById(@PathVariable(value = "postId") Long postId,
        ...
        CommentDto commentDto = commentServiceImpl.getCommentById(postId, commentId);
    ...
    public ResponseEntity<CommentDto> updateComment(@PathVariable(value = "postId") Long postId,
                                                    @PathVariable(value = "id") Long commentId,
                                                    @Valid @RequestBody CommentDto commentDto){
        CommentDto updatedComment = commentServiceImpl.updateComment(postId, commentId, commentDto);
